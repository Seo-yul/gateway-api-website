...
description: 'GEP-1897: BackendTLSPolicy - Explicit Backend TLS Connection Configuration
  (Standard)'
weight: 1897
status: Standard
authors:
...
[GEP-713]({{< ref "/geps/gep-713" >}}), that the implementation
...
established patterns of [consumer and producer policies]({{< ref "/overview/glossary" >}}#producer-route).
...
and [Istio / Destination Rule](https://istio.io/latest/reference/config/networking/destination-rule/#ClientTLSSettings)
...
[Gateway API TLS]({{< ref "/guides/user-guides/tls" >}})

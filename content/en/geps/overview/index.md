...
- On one of our [community meetings]({{< ref "/contributing" >}})
...
Once this feature has met the [graduation criteria]({{< ref "/overview/concepts/versioning" >}}#graduation-criteria), it is
...
GEPs should match the format of the template found in [GEP-696]({{< ref "/geps/gep-696" >}}).

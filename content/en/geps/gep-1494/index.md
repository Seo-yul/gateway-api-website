...
description: 'GEP-1494: HTTP Auth in Gateway API (Experimental)'
weight: 1494
status: Experimental
authors:
- youngnick
...
Gateway API already has some work in progress to handle this for straightforward use cases, in [GEP-91]({{< ref "/geps/gep-91" >}}).

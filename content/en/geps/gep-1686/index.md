...
description: 'GEP-1686: Mesh conformance testing plan (Standard)'
weight: 1686
status: Standard
authors:
- michaelbeaumont
...
Currently the GAMMA spec consists of two Gateway API GEPs [defining terminology and goals of Gateway API for service meshes]({{< ref "/geps/gep-1324" >}})
and specifically [how route resources work in a service mesh context]({{< ref "/geps/gep-1294" >}}).

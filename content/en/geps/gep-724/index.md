...
description: 'GEP-724: Refresh Route-Gateway Binding (Standard)'
weight: 724
status: Standard
authors:
- robscott
...
GEP]({{< ref "/geps/gep-709" >}}) was that of a handshake for
...
* [GEP 709: ReferenceGrant + Cross Namespace References from Routes]({{< ref "/geps/gep-709" >}})

...
description: 'GEP-3567: Gateway TLS Updates for HTTP/2 Connection Coalescing (Standard)'
weight: 3567
status: Standard
authors:
- robscott
...
documentation]({{< ref "/guides/user-guides/tls" >}}#wildcard-tls-listeners))

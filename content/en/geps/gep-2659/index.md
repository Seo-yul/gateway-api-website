...
description: 'GEP-2659: Document and improve the GEP process (Accepted)'
weight: 2659
status: Accepted
authors:
- youngnick
...
[GEP-1324]({{< ref "/geps/gep-1324" >}}) is a good example,
...
matching]({{< ref "/geps/gep-735" >}}) and
[GEP-1282: Describing Backend Properties]({{< ref "/geps/gep-1282" >}})).
In the case of GEP-1282, we now have a replacement GEP,
[GEP-1897: BackendTLSPolicy]({{< ref "/geps/gep-1897" >}})

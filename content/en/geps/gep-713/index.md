...
description: 'GEP-713: Metaresources and Policy Attachment (Memorandum)'
weight: 713
status: Memorandum
authors:
- youngnick
...
relationships:
  ...
  - name: Direct Policy Attachment
    number: 2648
    description: Former split out of the Direct class of policies (Declined)
  - name: Inherited Policy Attachment
    number: 2649
    description: Former split out of the Inherited class of policies (Declined)
---
...
(See status definitions [here]({{< ref "/geps/overview" >}}#gep-states))
...
- when changing the spec of the object to hold the new piece of information is not possible (e.g., `ReferenceGrant`, from [GEP-709]({{< ref "/geps/gep-709" >}}), when affecting Secrets and Services);
...
- [Ana]({{< ref "/overview/concepts/roles-and-personas" >}}#ana) or [Chihiro]({{< ref "/overview/concepts/roles-and-personas" >}}#chihiro) would like to specify some new behavior for a standard Kubernetes resource, but that resource doesn't have a way to specify the behavior and neither Ana nor Chihiro can modify it.
...
[https://istio.io/latest/reference/config/](https://istio.io/latest/reference/config/)

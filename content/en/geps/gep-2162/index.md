...
description: 'GEP-2162: Supported features in GatewayClass Status (Standard)'
weight: 2162
status: Standard
authors:
- LiorLieberman
...
Partnered with the [Conformance Profiles]({{< ref "/geps/gep-1709" >}}) work, we want to:
...
The current plan for conformance profiles is to also include centralized reporting. (more info in [gep-1709]({{< ref "/geps/gep-1709" >}}))

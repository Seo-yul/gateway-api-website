...
description: 'GEP-1651: Gateway Routability (Provisional)'
weight: 1651
status: Provisional
authors:
- dprotaso
...
`Cluster`|The address is routable inside the [cluster's network](https://kubernetes.io/overview/concepts/cluster-administration/networking/#how-to-implement-the-kubernetes-network-model)
...
const (
  ...
  // Implementations MAY support this routability
  //
  // [cluster's network](https://kubernetes.io/overview/concepts/cluster-administration/networking/#how-to-implement-the-kubernetes-network-model)

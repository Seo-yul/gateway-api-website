...
description: 'GEP-2648: Direct Policy Attachment (Declined)'
weight: 2648
status: Declined
authors:
- youngnick
...
relationships:
  ...
  - name: Metaresources and Policy Attachment
    number: 713
    description: Merged back into the original spec for Metaresources and Policy Attachment
      where it's presented as a well-defined class of metaresource
---
...
As an example, the BackendTLSPolicy is specified in [GEP-1897]({{< ref "/geps/gep-1897" >}}),
...
* HTTPRoute.Rules.Name (once they are added in [GEP-995]({{< ref "/geps/gep-995" >}}), implementation tracked by [#2985](https://github.com/kubernetes-sigs/gateway-api/pull/2985))
...
type PolicyAncestorStatus struct {
	...
	// (https://kubernetes.io/overview/concepts/overview/working-with-objects/names/#names).
	//
...
BackendTLSPolicy, introduced in [GEP-1897]({{< ref "/geps/gep-1897" >}})

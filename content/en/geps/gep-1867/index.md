...
description: 'GEP-1867: Per-Gateway Infrastructure (Standard)'
weight: 1867
status: Standard
authors:
- howardjohn
...
The distinction between these roles is explicitly called out on the [homepage]({{< ref "/geps/.." >}}#personas).
...
[Policy Attachment]({{< ref "/reference/policy-attachment" >}}) offers a hierarchy of defaults and overrides, allowing attachment to GatewayClass and Gateway.
...
One example GEP already depending on this is [GEP-1651]({{< ref "/geps/gep-1651" >}}).

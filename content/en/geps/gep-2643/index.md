---
toc_hide: true
title: 'GEP-2643: TLS based passthrough Route / TLSRoute'
description: 'GEP-2643: TLS based passthrough Route / TLSRoute (Standard)'
weight: 2643
status: Standard
authors:
- candita
...
relationships:
  ...
  - number: 4274
    name: BackendTLSPolicy - Extend support for TLSRoute
  - number: 4271
    name: TLSRoute/HTTPRoute multiplexing
featureNames:
- TLSRoute
...
`TLSRoute` - This will be covered by the [ListenerSet enhancement]({{< ref "/geps/gep-1713" >}}).
...
A typical [north/south]({{< ref "/overview/glossary" >}}#northsouth-traffic)

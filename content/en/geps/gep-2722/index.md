...
description: 'GEP-2722: Goals and UX for gwctl (Memorandum)'
weight: 2722
status: Memorandum
authors:
- gauravkghildiyal
...
relationships:
  ...
  - number: 713
    ...
    description: Explains the meaning of a Policy and calls out the idea of building
      a kubectl plugin or command-line tool.
---
...
* Complex policy attachment management:
    * As described in [GEP-713]({{< ref "/geps/gep-713" >}}),
...
* Evaluate how gwctl can be extended to support [Mesh use
  cases]({{< ref "/overview/mesh/index" >}})

## References

* [GEP-713: Metaresources and Policy
  Attachment]({{< ref "/geps/gep-713" >}})

...
description: 'GEP-1911: Backend Protocol Selection (Standard)'
weight: 1911
status: Standard
authors:
- dprotaso
...
Originally the use of this field in the Gateway API was rejected in [GEP-1282]({{< ref "/geps/gep-1282" >}}#non-goals):
...
Note: Kubernetes will automatically create `EndpointSlices` for `Services` that have a selector. [Custom `EndpointSlices`](https://kubernetes.io/overview/concepts/services-networking/service/#custom-endpointslices) can manually be created.
...
1. Only if there is a corresponding `BackendTLSPolicy` - see [GEP-1897]({{< ref "/geps/gep-1897" >}})
...
The first pass of this GEP proposed a new meta-resource [GEP-713]({{< ref "/geps/gep-713" >}}) called `BackendProtocol`.
...
From [GEP-1282]({{< ref "/geps/gep-1282" >}}#tldr):
...
This is considered untenable due to the 'the turnaround time for those changes can be years.' ([ref-1282]({{< ref "/geps/gep-1282" >}}#non-goals))

### Unstructured Data/Special Values

Unstructured data refers to using labels and annotations.

From [GEP-1282]({{< ref "/geps/gep-1282" >}}#non-goals):
...
- [Google GKE AppProtocol Selection](https://cloud.google.com/kubernetes-engine/overview/concepts/ingress-xlb#https_tls_between_load_balancer_and_your_application)

[k8s-service]: https://kubernetes.io/overview/concepts/services-networking/service/
[k8s-endpointslices]: https://kubernetes.io/overview/concepts/services-networking/endpoint-slices/

...
description: 'GEP-1323: Response Header Filter (Standard)'
weight: 1323
status: Standard
authors:
- aryan9600
...
This feature can be further extended via [Policy Attachment]({{< ref "/reference/policy-attachment" >}}). The mechanism and use cases of this may be explored in a future GEP.
...
* [Istio `Headers`](https://istio.io/latest/reference/config/networking/virtual-service/#Headers)

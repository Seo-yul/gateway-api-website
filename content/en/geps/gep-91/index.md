---
toc_hide: true
title: 'GEP-91: Client Certificate Validation for TLS terminating at the Gateway Listener'
description: 'GEP-91: Client Certificate Validation for TLS terminating at the Gateway
  Listener (Standard)'
weight: 91
status: Standard
authors:
...
(See definitions in [GEP States]({{< ref "/geps/overview" >}}#gep-states).)
...
[TLS Configuration GEP]: {{< ref "/geps/gep-2907" >}}

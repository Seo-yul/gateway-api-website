...
description: 'GEP-3171: Percentage-based Request Mirroring (Standard)'
weight: 3171
status: Standard
authors:
- jakebennert
...
Enhance the existing [Request Mirroring]({{< ref "/guides/user-guides/http-request-mirroring" >}}) feature by allowing users to specify a percentage of requests they'd like mirrored.

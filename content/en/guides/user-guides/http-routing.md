...
The [HTTPRoute resource]({{< ref "/reference/api-types/httproute" >}}) allows you to match on HTTP traffic and
...
documentation]({{< ref "/reference/api-types/httproute#merging" >}}).

...
The [GRPCRoute resource]({{< ref "/reference/api-types/grpcroute" >}}) allows you to match on gRPC traffic and
...
information on that, refer to the [documentation]({{< ref "/reference/api-types/httproute#merging" >}}).
...
[svc]:https://kubernetes.io/overview/concepts/services-networking/service/

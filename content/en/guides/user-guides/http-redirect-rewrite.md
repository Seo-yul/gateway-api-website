...
[HTTPRoute resources]({{< ref "/reference/api-types/httproute" >}}) can issue redirects to
clients or rewrite paths sent upstream using
[filters]({{< ref "/reference/api-types/httproute#filters-optional" >}}). This guide shows how
...
filters]({{< ref "/reference/spec#httprequestredirectfilter" >}})
...
[`URLRewrite`
filter]({{< ref "/reference/spec#httpurlrewritefilter" >}})

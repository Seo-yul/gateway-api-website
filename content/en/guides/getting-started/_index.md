...
- [Deploying a simple Gateway]({{< ref "/guides/getting-started/simple-gateway" >}})
- [HTTP routing]({{< ref "/guides/user-guides/http-routing" >}})
- [HTTP redirects and rewrites]({{< ref "/guides/user-guides/http-redirect-rewrite" >}})
- [HTTP traffic splitting]({{< ref "/guides/user-guides/traffic-splitting" >}})
- [Routing across Namespaces]({{< ref "/guides/user-guides/multiple-ns" >}})
- [Configuring TLS]({{< ref "/guides/user-guides/tls" >}})
- [TCP routing]({{< ref "/guides/user-guides/tcp" >}})
- [gRPC routing]({{< ref "/guides/user-guides/grpc-routing" >}})
...
- **[Migrating from Ingress]({{< ref "/guides/getting-started/migrating-from-ingress" >}})**: A general guide for migrating from any Ingress implementation to Gateway API. It covers the key differences and provides a manual migration example.
- **[A Welcome Guide for Ingress-NGINX Users]({{< ref "/guides/getting-started/migrating-from-ingress-nginx" >}})**: A guide specifically for users of Ingress-NGINX, the most popular Ingress implementation. It provides a set of resources and answers to frequently asked questions.

---

## Installing a Gateway controller

There are multiple projects that support Gateway API. By
...
Refer to the [server-side apply documentation](https://kubernetes.io/reference/using-api/server-side-apply/)
...
documentation]({{< ref "/overview/concepts/versioning" >}}).
...
[CRD Management Guide]({{< ref "/guides/crd-management" >}}).

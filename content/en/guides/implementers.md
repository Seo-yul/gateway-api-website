...
Although the [Gateway API versioning policy]({{< ref "/overview/concepts/versioning" >}}) largely
...
expand. There is a [TLS guide]({{< ref "/guides/user-guides/tls" >}}) that covers this topic in more depth
...
Certificates (see [Roles and Personas]({{< ref "/overview/concepts/roles-and-personas" >}}) for more on

...
Please refer to [Security Considerations]({{< ref "/overview/concepts/security#limiting-cross-namespace-references" >}})
for more details.
...
Please see the [API
Specification]({{< ref "/reference/spec#referencegrant" >}})
...
documentation]({{< ref "/overview/concepts/security" >}}). Although conceptually similar to

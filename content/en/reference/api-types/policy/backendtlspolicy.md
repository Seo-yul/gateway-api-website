...
aliases:
  - /reference/api-types/backendtlspolicy/
---
...
to our [versioning guide]({{< ref "/overview/concepts/versioning" >}}).
{{< /note >}}
...
configuration in Gateway API, see [TLS Configuration]({{< ref "/guides/user-guides/tls" >}}).

![Image showing three TLS Termination Types](/images/tls-termination-types.png)

BackendTLSPolicy is a Direct [PolicyAttachment]({{< ref "/reference/policy-attachment" >}}) without defaults or overrides,
...
[backendtlspolicy]: /reference/spec/#backendtlspolicy
[validation]: /reference/spec/#backendtlspolicyvalidation
[caCertificateRefs]: /reference/spec/#localobjectreference
[wellKnownCACertificates]: /reference/spec/#localobjectreference
[hostname]: /reference/spec/#precisehostname

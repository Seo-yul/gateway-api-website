...
Timeouts are optional, and their fields are of type [Duration]({{< ref "/geps/gep-2257" >}}). A zero-valued timeout ("0s") MUST be interpreted as disabling the timeout. A valid non-zero-valued timeout MUST be >= 1ms.
...
HTTPRoute Rules include an optional `name` field. The applications for the name of a route rule are implementation-specific. It can be used to reference individual route rules by name from other resources, such as in the `sectionName` field of metaresources ([GEP-2648]({{< ref "/geps/gep-2648" >}}#section-names)), in the status stanzas of resources related to the route object, to identify internal configuration objects generated by the implementation from HTTPRoute Rule, etc.
...
[httproute]: /reference/spec/#httproute
[httprouterule]: /reference/spec/#httprouterule
[hostname]: /reference/spec/#hostname
[rfc-3986]: https://tools.ietf.org/html/rfc3986
[matches]: /reference/spec/#httproutematch
[filters]: /reference/spec/#httproutefilter
[backendRef]: /reference/spec/#httpbackendref
[parentRef]: /reference/spec/#parentreference
[timeouts]: /reference/spec/#httproutetimeouts
[appProtocol]: https://kubernetes.io/overview/concepts/services-networking/service/#application-protocol
[sectionName]: /reference/spec/#sectionname

...
- [the device plugin framework](https://kubernetes.io/overview/concepts/extend-kubernetes/compute-storage-net/device-plugins/)
...
GRPCRoute Rules include an optional `name` field. The applications for the name of a route rule are implementation-specific. It can be used to reference individual route rules by name from other resources, such as in the `sectionName` field of metaresources ([GEP-2648]({{< ref "/geps/gep-2648" >}}#section-names)), in the status stanzas of resources related to the route object, to identify internal configuration objects generated by the implementation from GRPCRoute Rule, etc.
...
[grpcroute]: /reference/spec/#grpcroute
[grpcrouterule]: /reference/spec/#grpcrouterule
[hostname]: /reference/spec/#hostname
[rfc-3986]: https://tools.ietf.org/html/rfc3986
[matches]: /reference/spec/#grpcroutematch
[filters]: /reference/spec/#grpcroutefilter
[backendRef]: /reference/spec/#grpcbackendref
[parentRef]: /reference/spec/#parentreference
[name]: /reference/spec/#sectionname

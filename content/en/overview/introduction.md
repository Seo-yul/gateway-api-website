---
title: "Introduction"
description: "Kubernetes Gateway API - L4 and L7 routing in Kubernetes"
weight: 1
type: docs
---
...
[personas]({{< ref "/overview/concepts/roles-and-personas" >}}) and corresponding resources that
...
protocol-specific resources ([HTTPRoute]({{< ref "/reference/api-types/httproute" >}}),
[GRPCRoute]({{< ref "/reference/api-types/grpcroute" >}}), etc) enable advanced routing capabilities
...
## Gateway API for Ingress {#for-ingress}
...
information refer to our [versioning guide]({{< ref "/overview/concepts/versioning" >}}).
{{< /channel-version >}}

When using Gateway API to manage ingress traffic, the [Gateway]({{< ref "/reference/api-types/gateway" >}}) resource
...
Each Gateway is associated with a [GatewayClass]({{< ref "/reference/api-types/gatewayclass" >}}), which
...
[HTTPRoute]({{< ref "/reference/api-types/httproute" >}})) are then [associated with the Gateway
...
[Ingress API]: https://kubernetes.io/overview/concepts/services-networking/ingress/
[north/south traffic]: /overview/glossary/#northsouth-traffic
[east/west traffic]: /overview/glossary/#eastwest-traffic
...
The [GAMMA initiative]({{< ref "/overview/mesh/gamma" >}}) work for supporting service mesh use
cases has been part of the Standard Channel since v1.1.0 and is considered
GA. For more information refer to our [versioning guide]({{< ref "/overview/concepts/versioning" >}}).
{{< /channel-version >}}
...
cluster, the [Gateway]({{< ref "/reference/api-types/gateway" >}}) and
[GatewayClass]({{< ref "/reference/api-types/gatewayclass" >}}) resources are not used; instead,
individual route resources (such as [HTTPRoute]({{< ref "/reference/api-types/httproute" >}})) are
...
To date, [GAMMA]({{< ref "/overview/mesh" >}}) has been able to support mesh functionality with
...
[gamma]: /overview/mesh/
[service-mesh]: /overview/glossary/#service-mesh
[service-facets]: /overview/mesh/service-facets/
[mesh-attachment]: /overview/mesh/
...
- [API overview]({{< ref "/overview/concepts/api-overview" >}})
- [User guides]({{< ref "/guides/getting-started" >}})
- Implementations
- [API reference spec]({{< ref "/reference/spec" >}})
...
[numerous implementations](https://kubernetes.io/overview/concepts/services-networking/ingress-controllers/),
...
Personas]({{< ref "/overview/concepts/roles-and-personas" >}}).)
...
[use-cases]: {{< ref "/overview/concepts/use-cases" >}}
...
Check out the implementations reference to see the latest

...
title: "Overview"
weight: 1
description: "Using Gateway API for service mesh"
---
...
The "[GAMMA initiative]({{< ref "/overview/mesh/gamma" >}})" refers to the group that is defining how
...
[TCPRoute]: {{< ref "/overview/concepts/api-overview#tcproute-and-udproute" >}}
[Service]: https://kubernetes.io/overview/concepts/services-networking/service/
[service-mesh]: {{< ref "/overview/glossary#service-mesh" >}}
[service-facets]: {{< ref "/overview/mesh/service-facets" >}}

## Connecting routes and services {#gateway-api-for-mesh}
...
- Same Namespace {#producer-routes}
...
- Different Namespaces {#consumer-routes}
...
[Ana]: {{< ref "/overview/concepts/roles-and-personas#ana" >}}
[producer route]: {{< ref "/overview/glossary#producer-route" >}}
[consumer route]: {{< ref "/overview/glossary#consumer-route" >}}
[service mesh]: {{< ref "/overview/glossary#service-mesh" >}}
[Route merging rules]: {{< ref "/reference/api-types/httproute#merging" >}}

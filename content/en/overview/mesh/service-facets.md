...
weight: 20
description: "The different facets of a Kubernetes Service"
---
...
[gateway]({{< ref "/reference/api-types/gateway" >}}) and the [mesh]({{< ref "/overview/mesh" >}}) each need to decide whether

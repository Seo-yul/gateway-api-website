...
weight: 40
description: "The three primary roles and personas defined by Gateway API to balance usability, flexibility, and control."
---
...
[Security Model]: {{< ref "/overview/concepts/security#rbac" >}}

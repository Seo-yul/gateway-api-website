...
title: "Versioning"
weight: 80
description: "How Gateway API versions, release channels, and graduation criteria work."
---
...
feature or resource proposed by a new GEP (enhancement
...
* Standard Channel:
  ...
  policy](https://kubernetes.io/reference/using-api/deprecation-policy/)
* All Channels:
    ...
    * Introduction of a new API version which may include renamed fields or
      ...
      version](https://kubernetes.io/reference/using-api/#api-versioning)

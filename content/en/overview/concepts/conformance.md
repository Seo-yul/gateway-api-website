...
title: "Conformance"
weight: 30
description: "Conformance definitions, tests, and profiles that ensure a consistent Gateway API experience across implementations."
---
...
[versioning]({{< ref "/overview/concepts/versioning" >}}) documentation.
...
[network_plugins]: https://kubernetes.io/overview/concepts/extend-kubernetes/compute-storage-net/network-plugins/
[netpol]: https://kubernetes.io/overview/concepts/services-networking/network-policies/

...
title: "API Overview"
weight: 10
description: "An overview of the Gateway API resource model, roles, and how Routes attach to Gateways and Services."
---
...
This is similar to
[IngressClass](https://kubernetes.io/overview/concepts/services-networking/ingress/#ingress-class)
for Ingress and
[StorageClass](https://kubernetes.io/overview/concepts/storage/storage-classes/) for
...
For more information on this, see the [Traffic Matching]({{< ref "/overview/concepts/traffic-matching" >}}) page.
...
The feature name for this feature is `HTTPRouteParentRefPort`, and you should be able to find out if your implementation supports it either in the implementation's GatewayClass (under `status.supportedFeatures`), or on one of the implementation comparison pages (like the v1.4 comparison.)
{{< /note >}}
...
Please refer to the [TLS details]({{< ref "/guides/user-guides/tls" >}}) guide for a deep dive on TLS.
...
[GAMMA routing documentation]: {{< ref "/overview/mesh#connecting-routes-and-services" >}}

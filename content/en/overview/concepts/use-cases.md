...
title: "Use Cases"
weight: 70
description: "Example use cases demonstrating how Gateway API serves north/south and east/west traffic scenarios."
---
...
[roles and personas]: {{< ref "/overview/concepts/roles-and-personas" >}}
...
TLS]({{< ref "/guides/user-guides/tls#downstream-tls" >}}) at the Gateway, while simultaneously allowing
Ana and her colleagues control over the application's [routing
logic]({{< ref "/guides/user-guides/http-routing" >}}) and rollout plans (e.g. [traffic splitting
rollouts]({{< ref "/guides/user-guides/traffic-splitting" >}})).

[north/south]: {{< ref "/overview/glossary#northsouth-traffic" >}}
...
policies [such as TLS]({{< ref "/guides/user-guides/tls#downstream-tls" >}}) can be enforced at the
Gateway. Meanwhile, Ana and Allison run their applications [in their own
Namespaces]({{< ref "/guides/user-guides/multiple-ns" >}}), but attach their Routes to the same shared
Gateway, allowing them to independently control their [routing
logic]({{< ref "/guides/user-guides/http-routing" >}}), [traffic splitting
rollout]({{< ref "/guides/user-guides/traffic-splitting" >}}), etc., while not worrying about the things
that Chihiro and Ian are handling.

[HTTPRoute]: {{< ref "/reference/api-types/httproute" >}}
[GatewayClass]: {{< ref "/reference/api-types/gatewayclass" >}}
[Gateway]: {{< ref "/reference/api-types/gateway" >}}
[Route Attachment Process]: {{< ref "/overview/concepts/api-overview#attaching-routes-to-gateways" >}}
...
[east/west]: {{< ref "/overview/glossary#eastwest-traffic" >}}
...
TLS]({{< ref "/guides/user-guides/tls#downstream-tls" >}}) at the Gateway, while allowing Ana and
Allison to retain independent control of [routing
logic]({{< ref "/guides/user-guides/http-routing" >}}), [traffic splitting
rollout]({{< ref "/guides/user-guides/traffic-splitting" >}}), etc., both for [north/south] and for
[east/west] routing.




[gateway controller]: {{< ref "/overview/glossary#gateway-controller" >}}
[Service routing]: {{< ref "/overview/glossary#service-routing" >}}
[endpoint routing]: {{< ref "/overview/glossary#endpoint-routing" >}}

...
title: "역할 및 페르소나"
weight: 40
description: "사용성, 유연성 및 제어의 균형을 맞추기 위해 Gateway API에서 정의한 세 가지 주요 역할과 페르소나"
---
...
* **Chihiro** (그들/그들의)은 _클러스터 운영자_ 로서,
...
[보안 모델]: {{< ref "/overview/concepts/security#rbac" >}}

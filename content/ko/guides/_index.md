...
title: "가이드"
weight: 2
description: "How-to guides for Gateway API"
type: docs
toc_root: true
cascade:
  type: docs
...
- [Simple Gateway]({{< ref "/guides/getting-started/simple-gateway" >}}) (a good one to start out with)
...
- [Migrating from Ingress]({{< ref "/guides/getting-started/migrating-from-ingress" >}})

## Installing a Gateway controller

There are [multiple projects]({{< ref "/overview/implementations" >}}) that support Gateway API. By
